		...
		\1 Active Mode Relationships:	
			...
			\begin{figure}[!htb]
				...
				\begin{circuitikz}[american]
					\draw (0,-0.0) node[ocirc, label={above}] () {} to[short] (1,-0.0);
					\draw (1,-0.0) to[D,l=$D$] (1,-2.0);
					\draw (3,-0.0) to[cI,l=$I$] (3,-2.0);
					\draw (3,-0.0) to[short] (4,-0.0) node[ocirc] () {$C$};
					\draw (1,-2.0) to[short] (3,-2.0);
					\draw (2,-2.0) to[short] (2,-3.0) node[ocirc] () {$E$};
				\end{circuitikz}
			\end{figure}
	\end{outline}
